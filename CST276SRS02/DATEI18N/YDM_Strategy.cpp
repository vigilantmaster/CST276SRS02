...
bool YDM_Strategy::is_date_valid(const int month, const int day, const int year)
{
...
bool YDM_Strategy::is_date_valid(std::string date)
{
	return parse_stringstream(date);
}

bool YDM_Strategy::parse_stringstream(std::string inputString)
{
...
bool YDM_Strategy::leap_year(const int year)
{

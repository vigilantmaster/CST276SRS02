...
bool DMY_Strategy::is_date_valid(const int month, const int day, const int year)
{
...
bool DMY_Strategy::is_date_valid(std::string date)
{
	return parse_stringstream(date);
}

bool DMY_Strategy::parse_stringstream(std::string inputString)
{
...
bool DMY_Strategy::leap_year(const int year)
{

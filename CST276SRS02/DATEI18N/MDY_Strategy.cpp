...
bool MDY_Strategy::is_date_valid(const int month, const int day, const int year)
{
...
bool MDY_Strategy::is_date_valid(std::string date)
{
	return parse_stringstream(date);
}

bool MDY_Strategy::parse_stringstream(std::string inputString)
{
...
bool MDY_Strategy::leap_year(const int year)
{
